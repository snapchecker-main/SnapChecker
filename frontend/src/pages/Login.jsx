...
export default function Login() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gray-50/50 p-4 sm:p-8 text-gray-900">
      <style>{`
      ...
      {/* This locks the max width to 1080px so it never stretches too far on large monitors */}
      <div className="flex w-full max-w-[1080px] min-h-[640px] overflow-hidden rounded-2xl bg-white shadow-[0_8px_40px_rgb(0,0,0,0.06)] border border-gray-100">
        {/* Left Red Panel (Now bounded by the card, no longer infinite height) */}
        <div className="hidden w-[40%] lg:w-[45%] bg-primary md:flex flex-col p-8 lg:p-12 text-white relative shrink-0">
          ...
          <div className="relative z-10 w-full max-w-[360px] mx-auto flex flex-col h-full justify-between py-2">
            {/* Logo Header */}
        ...
        <div className="flex flex-1 flex-col items-center justify-center p-6 sm:p-12 relative bg-white">
          <div className="w-full max-w-[380px] animate-fade-slide" key={mode}>
